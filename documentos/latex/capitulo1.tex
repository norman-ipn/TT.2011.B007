...
{\it Kinect}\texttrademark es un dispositivo que combina una cámara {\it RGB}, un sensor de profundidad y un arreglo de micrófonos\cite{Robotics}.\\

Como podemos observar en el Cuadro \ref{tab:1}, se listan los elementos principales de {\it Kinect}\texttrademark junto con su función.
...
\begin{itemize}
	\item Lograr una configuración para usar {\it Kinect}\texttrademark con la computadora personal, para desarrollar una aplicación.
