...
para aprovechar sus capacidades, principalmente la de eliminar los dispositivos físicos para controlar, en este caso, la computadora personal.

OpenNI poseé una biblioteca de código abierto para poder trabajar con casi todas las capacidades de {\it Kinect}\texttrademark en {\it Windows}, {\it Linux} y {\it Mac}.

Se utilizó {\it OpenNI framework (Open Source Natural Interaction)} versión $1$.$3$.$4$.$6$.

\section{OpenCV}

{\it OpenCV (Open Source Computer Vision Library)} es una biblioteca con licencia {\it GPL}, 
orientada a la computación visual en tiempo real, utilizada principalmente en el campo de 
la Interacción Computadora - Humano, por sus siglas en inglés {\it HCI (Human Computer Interaction)} creada y soportada por la compañia Intel desde 1999. 

Actualmente trabajamos con la versión $2$.$3$.$1$ de la librería {\it OpenCV}.\\

Una de las características más importantes de {\it OpenCV} es que las funciones están 
